      ...
      <div className="flex space-x-4">
        ...
        >
          ...
          <div className="flex flex-col pl-1 pt-3 sm:pl-5">
            <h1 className="pb-4 text-xl sm:text-2xl"> 𝙈𝙔𝙏𝙃: "𝙔𝙤𝙪 𝘾𝙖𝙣’𝙩 𝙂𝙚𝙩 𝙋𝙧𝙚𝙜𝙣𝙖𝙣𝙩 𝘿𝙪𝙧𝙞𝙣𝙜 𝙔𝙤𝙪𝙧 𝙋𝙚𝙧𝙞𝙤𝙙."</h1>
        ...
        >
          ...
          <div className="flex flex-col pl-1 pt-3 sm:pl-5">
            <h1 className="pb-5 text-xl sm:text-2xl"> 𝙈𝙔𝙏𝙃: "𝙑𝙖𝙜𝙞𝙣𝙖𝙡 𝘿𝙞𝙨𝙘𝙝𝙖𝙧𝙜𝙚 = 𝙄𝙣𝙛𝙚𝙘𝙩𝙞𝙤𝙣."</h1>
            <p className="text-justify pr-5 pt-1">
        ...
        >
          ...
          <div className="flex flex-col pl-1 pt-3 sm:pl-5">
            <h1 className="pb-5 text-xl sm:text-2xl"> 𝙈𝙔𝙏𝙃: "𝙒𝙚𝙖𝙧𝙞𝙣𝙜 𝙖 𝘽𝙧𝙖 24/7 𝙋𝙧𝙚𝙫𝙚𝙣𝙩𝙨 𝙎𝙖𝙜𝙜𝙞𝙣𝙜."</h1>
            <p className="text-justify pr-5 pt-1">
        ...
        >
          ...
          <div className="flex flex-col pl-1 pt-3 sm:pl-5">
            <h1 className="pb-5 text-xl sm:text-2xl"> 𝙈𝙔𝙏𝙃: "𝘾𝙤𝙡𝙙 𝘿𝙧𝙞𝙣𝙠𝙨 𝙈𝙖𝙠𝙚 𝙋𝙚𝙧𝙞𝙤𝙙 𝘾𝙧𝙖𝙢𝙥𝙨 𝙒𝙤𝙧𝙨𝙚."</h1>
            <p className="text-justify pr-5 pt-1">
        ...
        >
          ...
          <div className="flex flex-col pl-1 pt-3 sm:pl-5">
            <h1 className="pb-4 text-xl sm:text-2xl"> 𝙈𝙔𝙏𝙃: "𝙎𝙝𝙖𝙫𝙞𝙣𝙜 𝙈𝙖𝙠𝙚𝙨 𝙃𝙖𝙞𝙧 𝙂𝙧𝙤𝙬 𝘽𝙖𝙘𝙠 𝙏𝙝𝙞𝙘𝙠𝙚𝙧 & 𝘿𝙖𝙧𝙠𝙚𝙧."</h1>
            <p className="text-justify pr-5 pt-1">
        ...
        >
          ...
          <div className="flex flex-col pl-1 pt-3 sm:pl-5">
            <h1 className="pb-5 text-xl sm:text-2xl"> 𝙈𝙔𝙏𝙃: "𝙒𝙤𝙢𝙚𝙣 𝙉𝙚𝙚𝙙 𝙇𝙚𝙨𝙨 𝙋𝙧𝙤𝙩𝙚𝙞𝙣 𝙏𝙝𝙖𝙣 𝙈𝙚𝙣."</h1>
            <p className="text-justify pr-5 pt-1">
