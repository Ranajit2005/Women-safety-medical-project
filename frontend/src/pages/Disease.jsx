  ...
  const cardData = [
    {
      ...
      hoverContent:
        "  𝑰𝒎𝒑𝒂𝒄𝒕 & 𝑹𝒊𝒔𝒌𝒔: 🔹 𝑪𝒉𝒓𝒐𝒏𝒊𝒄 𝒂𝒏𝒆𝒎𝒊𝒂 𝒂𝒏𝒅 𝒄𝒐𝒏𝒔𝒕𝒂𝒏𝒕 𝒇𝒂𝒕𝒊𝒈𝒖𝒆 🔹 𝑯𝒊𝒈𝒉𝒆𝒓 𝒓𝒊𝒔𝒌 𝒐𝒇 𝒊𝒏𝒇𝒆𝒓𝒕𝒊𝒍𝒊𝒕𝒚 𝒂𝒏𝒅 𝒎𝒊𝒔𝒄𝒂𝒓𝒓𝒊𝒂𝒈𝒆 🔹 𝑺𝒆𝒗𝒆𝒓𝒆 𝒑𝒂𝒊𝒏 𝒂𝒇𝒇𝒆𝒄𝒕𝒊𝒏𝒈 𝒅𝒂𝒊𝒍𝒚 𝒂𝒄𝒕𝒊𝒗𝒊𝒕𝒊𝒆𝒔 🔹 𝑰𝒏𝒄𝒓𝒆𝒂𝒔𝒆𝒅 𝒍𝒊𝒌𝒆𝒍𝒊𝒉𝒐𝒐𝒅 𝒐𝒇 𝒉𝒚𝒔𝒕𝒆𝒓𝒆𝒄𝒕𝒐𝒎𝒚  💡 𝑷𝒓𝒆𝒗𝒆𝒏𝒕𝒊𝒗𝒆 𝑴𝒆𝒂𝒔𝒖𝒓𝒆𝒔: 🔹 𝑴𝒂𝒊𝒏𝒕𝒂𝒊𝒏 𝒉𝒐𝒓𝒎𝒐𝒏𝒂𝒍 𝒃𝒂𝒍𝒂𝒏𝒄𝒆 𝒘𝒊𝒕𝒉 𝒍𝒊𝒇𝒆𝒔𝒕𝒚𝒍𝒆 𝒄𝒉𝒂𝒏𝒈𝒆𝒔 🔹 𝑬𝒂𝒓𝒍𝒚 𝒎𝒆𝒅𝒊𝒄𝒂𝒍 𝒄𝒉𝒆𝒄𝒌𝒖𝒑𝒔 𝒇𝒐𝒓 𝒅𝒊𝒂𝒈𝒏𝒐𝒔𝒊𝒔 🔹 𝑼𝒔𝒆 𝒐𝒇 𝒑𝒂𝒊𝒏 𝒎𝒂𝒏𝒂𝒈𝒆𝒎𝒆𝒏𝒕 𝒕𝒆𝒄𝒉𝒏𝒊𝒒𝒖𝒆𝒔 🔹 𝑨𝒗𝒐𝒊𝒅 𝒆𝒙𝒄𝒆𝒔𝒔𝒊𝒗𝒆 𝒆𝒔𝒕𝒓𝒐𝒈𝒆𝒏 𝒊𝒏𝒕𝒂𝒌𝒆",
    },
    {
